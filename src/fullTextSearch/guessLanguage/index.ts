// borrowed from https://github.com/richtr/guessLanguage.js/blob/master/lib/guessLanguage.js
// adapted for typescript

// below is the original copyright info
...
import { models } from './_languageData';
...
const guessLanguageImpl = function () {
  ...
  function check(sample, langs, callback) {
    ...
    const sortedScores = scoresArr.sort(function (objA, objB) {
  ...
  function createKnownModel(key) {
    ...
    // Construct known trigram object based on provided raw data
    const knownModel = {};
...
export const guessLanguage = guessLanguageImpl();
